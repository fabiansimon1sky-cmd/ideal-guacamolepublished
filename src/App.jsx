    ...
    <div className="app-shell">
      ...
      <main className="main-content">
        ...
        <div className="content-wrap">
          <section className="welcome-row"><div><p className="eyebrow">Live shipment tracking</p><h1>Vehicles in transit <span>✦</span></h1><p className="subheading">Tracking number <strong>{trackingNumber}</strong> · Booked September 21, 2025.</p></div><button className="date-button">Updated just now <span>⌄</span></button></section>
